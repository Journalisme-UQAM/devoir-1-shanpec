...
### Les commentaires précédés de trois dièses (###) sont ceux du prof (JHR) :)

### Tes deux solutions sont bonnes. On préfèrera généralement la plus simple, donc la seconde.
### Merci de m'avoir fait connaître la méthode .zfill, dont j'ignorais l'existence! «Zero fill». Chouette! :)